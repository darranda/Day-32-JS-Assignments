...
/*Create a function called removeItem that takes an item object as a parameter, retrieves the cart from localStorage, 
removes the item with the given id from the cart, and then stores the updated cart back into localStorage.*/
